      ...
      <div
        className={`fixed top-0 left-0 right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250] ${
          ifCartState
            ...
            : "opacity-0 invisible translate-x-18"
        }`}
      >
        <div
        ...
        >
          ...
          {cartItems.length === 0 ? (
            ...
            <div className="">
              <div className="flex items-start justify-start flex-col lg:gap-y-5 overflow-y-scroll h-[81vh] scroll-smooth scroll-hidden py-3">
              ...
              <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
                <div className="flex items-center justify-between">
                  ...
                  <h1 className="text-sm rounded bg-theme-cart text-sky-100 px-1 py-0.5">
                    ${totalAmount}
                  </h1>
                </div>
