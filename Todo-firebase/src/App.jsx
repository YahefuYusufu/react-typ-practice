...
const style = {
  bg: `h-screen w-screen flex justify-center items-center p-4 bg-gradient-to-r from-[#2f80ED]  to-[#56CCF2]`,
  container: `max-w-[500px] w-full m-auto bg-white rounded-lg shadow-lg p-4`,
